        ...
        <form onSubmit={handleSubmit} className="space-y-10 max-w-4xl mx-auto pb-20">
            <div className="flex items-center justify-between pb-8 border-b border-stone-100">
                ...
                <div className="flex gap-4">
                    ...
                    <button type="submit" disabled={isLoading} className="px-8 py-3 bg-amber-600 text-white font-black rounded-2xl hover:bg-amber-700 transition-all text-xs uppercase tracking-widest leading-none flex items-center gap-2 shadow-xl shadow-amber-600/20 disabled:opacity-50">
            ...
            <div className="grid md:grid-cols-5 gap-8">
                    ...
                    <section className="bg-white p-8 rounded-[2rem] border border-stone-100 shadow-sm space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <input
                                ...
                                className="w-full px-6 py-4 bg-stone-50 rounded-2xl text-2xl font-black tracking-widest border-2 border-transparent focus:bg-white focus:border-amber-500 transition-all outline-none uppercase"
                            />
                        </div>
                    </section>

                    <section className="bg-white p-8 rounded-[2rem] border border-stone-100 shadow-sm space-y-8">
                        <div className="flex items-center gap-3">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <input
                                    ...
                                    className="w-full px-6 py-2.5 bg-stone-100 rounded-xl font-black text-stone-900 text-center"
                                />
                            </div>
                        </div>
                    </section>
                ...
                <div className="md:col-span-2 space-y-8">
                    <section className="bg-stone-900 p-8 rounded-[2rem] text-white shadow-2xl space-y-6">
                        <div className="flex items-center gap-3">
