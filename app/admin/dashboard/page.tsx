    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-8">
        ...
        <div className="flex gap-4">
          <Link href="/admin/products/new" className="px-8 py-3.5 bg-stone-900 text-white font-black rounded-2xl hover:bg-stone-800 transition-all flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] shadow-2xl active:scale-95">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {dashboardStats.map((stat, index) => (
          <div key={index} className="bg-white rounded-[2.5rem] p-8 border border-stone-100 shadow-sm hover:shadow-2xl transition-all duration-500 group relative overflow-hidden">
      ...
      <div className="grid lg:grid-cols-3 gap-10">
        {/* Transaction Stream */}
        <div className="lg:col-span-2 bg-white rounded-[3rem] border border-stone-100 shadow-sm overflow-hidden flex flex-col">
          <div className="p-10 border-b border-stone-50 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-stone-50 rounded-2xl flex items-center justify-center text-stone-900 border border-stone-100 shadow-inner">
            ...
            <Link href="/admin/orders" className="p-3 bg-stone-50 text-stone-400 hover:text-stone-900 rounded-xl transition-all border border-transparent hover:border-stone-100">
        ...
        <div className="space-y-10">
          <div className="bg-stone-900 rounded-[3rem] p-10 text-white relative overflow-hidden shadow-2xl group border border-white/5">
            ...
            <div className="relative">
              <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center text-amber-500 mb-8 backdrop-blur-sm border border-white/10">
              ...
              <Link href="/admin/coupons/new" className="w-full py-4 bg-white text-stone-900 font-black rounded-2xl hover:bg-amber-500 hover:text-white transition-all inline-flex items-center justify-center gap-3 text-[10px] uppercase tracking-[0.2em] shadow-xl active:scale-95">
                Generate Token
